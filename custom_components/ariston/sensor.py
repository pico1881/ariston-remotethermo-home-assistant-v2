...
sensors_default = {
    ...
    PARAM_CH_ENERGY_TODAY: [SENSOR_CH_ENERGY_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
    PARAM_DHW_ENERGY_TODAY: [SENSOR_DHW_ENERGY_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
    ...
    PARAM_CH_ENERGY2_TODAY: [SENSOR_CH_ENERGY2_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
    PARAM_DHW_ENERGY2_TODAY: [SENSOR_DHW_ENERGY2_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
    ...
    PARAM_CH_ENERGY_DELTA_TODAY: [SENSOR_CH_ENERGY_DELTA_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
    PARAM_DHW_ENERGY_DELTA_TODAY: [SENSOR_DHW_ENERGY_DELTA_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", SensorStateClass.TOTAL_INCREASING],
